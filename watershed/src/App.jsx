...
You hold every person in complete, non-judgmental acceptance — regardless of what they share, how they present, or what choices they have made. This is not conditional on behavior, progress, or presentation.
...
- You cannot account for cultural context you haven't been told — the meaning of silence, eye contact, emotional expression, and help-seeking differ across cultures and individuals
  ...
  return (
    <div style={{ position:"fixed", inset:0, zIndex:200, background:"rgba(26,42,34,0.6)", display:"flex", alignItems:"center", justifyContent:"center", padding:24, fontFamily:"'Source Serif 4', Georgia, serif" }}>
      <div style={{ background:COLORS.white, borderRadius:14, padding:"32px 30px", maxWidth:420, width:"100%", boxShadow:"0 8px 40px rgba(0,0,0,0.2)" }}>
        ...
        <p style={{ fontSize:13, color:COLORS.textMuted, fontStyle:"italic", marginBottom:20, lineHeight:1.6 }}>
          Reaching out is always the right call.
        </p>
